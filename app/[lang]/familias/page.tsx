...
export default function Page({ params: { lang } }: PageProps) {
  ...
  const guides = [
    { title: es ? 'Guía de estimulación temprana en casa' : 'Early stimulation guide at home', icon: '👶', desc: es ? 'Actividades prácticas organizadas por edad para estimular el desarrollo de tu hijo desde el hogar.' : 'Practical activities organized by age to stimulate your child\'s development from home.', pages: es ? '24 págs.' : '24 pages', program: 'Mi Escuelita Down', color: '#2466a8', bg: 'bg-secondary/10' },
    { title: es ? 'Estrategias para el manejo de conducta' : 'Behavior management strategies', icon: '🧩', desc: es ? 'Técnicas basadas en evidencia para abordar conductas desafiantes con paciencia y efectividad.' : 'Evidence-based techniques to address challenging behaviors with patience and effectiveness.', pages: es ? '18 págs.' : '18 pages', program: 'Aula Wawitas', color: '#e86840', bg: 'bg-accent/10' },
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="bg-gradient-to-br from-[#fdf2f8] to-[#fdf6e3] rounded-3xl p-8 md:p-10 border border-accent/10 shadow-sm text-left relative overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row items-start gap-6 relative z-10">
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#8c3cbd] to-[#e86840] text-white flex items-center justify-center text-3xl shadow-md flex-shrink-0 select-none">
                💌
              </div>
              <div>
                ...
                <p className="text-xs sm:text-sm font-bold text-accent italic mt-4">
            ...
            {virtualSessions.map((s, idx) => (
              ...
              >
                ...
                <div className="p-6 md:p-8 flex items-start gap-5">
                  ...
                  <div>
                    <h4 className="font-serif text-base sm:text-lg text-[#111827] font-bold mb-2">
                      {s.title}
                    </h4>
              ...
              >
                <div>
                  ...
                  <div className="p-6">
                    ...
                    <h4 className="font-serif text-sm sm:text-base text-[#111827] font-bold mb-2 leading-snug">
                      {g.title}
                    </h4>
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between p-5 select-none">
                    ...
                    <div className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-semibold transition-all duration-300 ${isOpen ? 'bg-primary/10 text-primary-700 rotate-180' : 'bg-gray-50 text-gray-400'
                      }`}>
                      ▾
                    </div>
                  </div>
