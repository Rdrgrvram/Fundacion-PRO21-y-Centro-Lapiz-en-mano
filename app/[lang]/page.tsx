...
import { getHomeContent, getSiteSettings, getAllTeamAreas } from '@/lib/cms'
...
export default function Page({ params }: { params: { lang: Locale } }) {
  ...
  const whatsappUrl = waLink(settings.contact.whatsapp_number)
    ...
    <div className="bg-white">
              ...
              return (
                ...
                >
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    ...
                    >
                      {content.programs_teaser.cta_label}
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <span className="text-xs font-bold uppercase tracking-widest text-accent bg-accent/10 px-4 py-1.5 rounded-full">
              {content.testimonials_section.badge}
            </span>
      ...
      <section className="py-16 bg-white border-t border-gray-100">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            {content.team_preview.cta_label} →
          </Link>
        </div>
      </section>
